...
ggplot(yearly, aes(x = year, y = proportion_deaths, colour = clinic)) +
  geom_line() +
    ggtitle("Comparison of proportion of deaths of Clinic 1 and Clinic 2")
...
ggplot(monthly, mapping = aes(x = date, y = proportion_deaths)) +
geom_line() +
labs(x = "Year", y = "Proportion Deaths") +
ggtitle("Effect of Handwashing on Proportion of Deaths")
...
ggplot(monthly, mapping = aes(x = date, y = proportion_deaths, color = handwashing_started)) +
geom_line() +
labs(x = "Year", y = "Proportion Deaths") +
...
# Calculating the mean proportion of deaths as percentage 
# before and after handwashing.

monthly_summary <- monthly %>%
    group_by(handwashing_started) %>%
    summarise(mean_proportion_deaths = mean(proportion_deaths) * 100)
